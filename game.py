...
ITEMS_DATABASE = {
    ...
    "死霊の杖": {
        "type": "weapon",
        "attack": 45,
        "ability": "攻撃時25%でアンデッド召喚（次ターンHP20回復）",
        "description": "死霊を操る杖。"
    },
    "不死王の冠": {
        "type": "armor",
    ...
    "虚無の剣": {
        "type": "weapon",
        "attack": 48,
        "ability": "攻撃時30%で敵の防御力無視、MP吸収10",
        "description": "虚無の力を宿す剣。"
    },
    "幻影の鎧": {
        "type": "armor",
        "defense": 40,
        "ability": "回避率+30%、幻影分身（被攻撃時20%で回避）",
    ...
    "カオスブレード": {
        "type": "weapon",
        "attack": 52,
        "ability": "攻撃時ランダム効果（燃焼・毒・麻痺・即死のいずれか）",
        "description": "混沌の力を宿す剣。予測不能な力。"
    },
    "混沌の鎧": {
        "type": "armor",
        "defense": 48,
        "ability": "全状態異常耐性+50%、ランダム属性耐性+80%",
    ...
    "炎の剣": {
        "type": "weapon",
        "attack": 55,
        "ability": "炎属性攻撃、攻撃時50%で燃焼（5ターン、ダメージ20）",
        "description": "炎を司る神剣。"
    },
    "再生の鎧": {
        "type": "armor",
        "defense": 46,
        "ability": "毎ターンHP+15回復、瀕死時HP+50回復",
    ...
    "滅びの剣": {
        "type": "weapon",
        "attack": 58,
        "ability": "攻撃力+30%、攻撃時20%で敵の最大HP-10%",
        "description": "滅びを齎す魔剣。"
    },
    "終焉の盾": {
        "type": "armor",
    ...
    "精霊の盾": {
        "type": "armor",
        "defense": 50,
        "ability": "全属性耐性+40%、精霊加護（致死ダメージ時1回生存）",
    ...
    "天の槌": {
        "type": "weapon",
        "attack": 65,
        "ability": "攻撃力+40%、クリティカル時ダメージ3倍、神聖属性",
        "description": "天界の鍛冶神が造りし槌。"
    },
    "神の盾": {
        "type": "armor",
        "defense": 55,
        "ability": "全ダメージ-35%、神の加護（HP30%以下で防御力2倍）",
    ...
    "暗黒聖剣": {
        "type": "weapon",
        "attack": 68,
        "ability": "攻撃時HP吸収50%、闇属性、聖属性の敵に特効+100%",
        "description": "堕ちた聖剣。闇に染まりし力。"
    },
    "堕天の鎧": {
        "type": "armor",
        "defense": 58,
        "ability": "HP+100、攻撃力+25%、防御力+25%",
    ...
    "水神の槍": {
        "type": "weapon",
        "attack": 70,
        "ability": "水属性、攻撃時30%で敵を凍結（2ターン行動不能）",
        "description": "水神が持つ聖槍。"
    },
    "深海の鎧": {
        "type": "armor",
        "defense": 60,
        "ability": "水・氷耐性100%、HP自動回復+20/ターン",
    ...
    "地獄門の鎧": {
        "type": "armor",
        "defense": 62,
        "ability": "HP+150、被攻撃時30%で反撃ダメージ50",
    ...
    "幻影剣": {
        "type": "weapon",
        "attack": 75,
        "ability": "回避率+40%、攻撃時分身攻撃（2回攻撃）",
        "description": "幻影を生み出す神秘の剣。"
    },
    "幻王の鎧": {
        "type": "armor",
        "defense": 65,
        "ability": "回避率+50%、被攻撃時50%で完全回避",
    ...
    "竜帝剣": {
        "type": "weapon",
        "attack": 80,
        "ability": "ドラゴン特効+200%、全ステータス+20%、竜の咆哮（敵怯み）",
        "description": "竜帝が振るう至高の剣。"
    },
    "竜帝の鎧": {
        "type": "armor",
        "defense": 70,
        "ability": "HP+200、全属性耐性+50%、竜鱗の守護（致死ダメージ無効1回）",
    ...
    "混沌神剣": {
        "type": "weapon",
        "attack": 85,
        "ability": "攻撃力+50%、毎攻撃ランダム追加効果、ボスに特効+150%",
        "description": "混沌の神が振るう禁断の剣。"
    },
    "創世の盾": {
        "type": "armor",
        "defense": 75,
        "ability": "全ダメージ-50%、HP+300、完全蘇生（戦闘中1回のみ）",
    ...
    "死神大鎌": {
        "type": "weapon",
        "attack": 88,
        "ability": "攻撃時50%で即死、失敗時でもHP-50%、アンデッド特効+300%",
        "description": "死神が持つ究極の大鎌。"
    },
    "死帝の鎧": {
        "type": "armor",
        "defense": 78,
        "ability": "HP+350、全状態異常無効、不死の力（HP0で復活3回まで）",
        ...
        "enemies": [
            {
                ...
                "drops": [
                    ...
                    {"item": "coins", "amount": [30, 70], "weight": 12}
                ]
            },
            {
                "name": "スケルトン",
                ...
                "drops": [
                    ...
                    {"item": "骨の盾", "weight": 25},
                    {"item": "死者の兜", "weight": 12},
                    {"item": "高級回復薬", "weight": 18},
                    {"item": "coins", "amount": [35, 80], "weight": 15}
                ]
            },
            {
                "name": "ゾンビ",
                ...
                "drops": [
                    ...
                    {"item": "呪いの剣", "weight": 15},
                    {"item": "不死の鎧", "weight": 8},
                    {"item": "高級回復薬", "weight": 17},
                    {"item": "coins", "amount": [40, 90], "weight": 15}
                ]
            }
        ]
    },
        ...
        "enemies": [
            {
                ...
                "drops": [
                    ...
                    {"item": "地獄の鎧", "weight": 8},
                    {"item": "万能薬", "weight": 14},
                    {"item": "coins", "amount": [80, 150], "weight": 20}
                ]
            },
            {
                "name": "ドラゴン",
                ...
                "drops": [
                    {"item": "竜の鱗", "weight": 30},
                    {"item": "竜の牙", "weight": 25},
                    {"item": "ドラゴンソード", "weight": 12},
                    {"item": "万能薬", "weight": 15},
                    {"item": "coins", "amount": [100, 200], "weight": 18}
                ]
            },
            {
                "name": "ダークナイト",
                ...
                "exp": 35,
                "drops": [
                    {"item": "黒騎士の剣", "weight": 25},
                    {"item": "黒騎士の盾", "weight": 25},
                    {"item": "黒騎士の鎧", "weight": 15},
                    {"item": "万能薬", "weight": 15},
                    {"item": "coins", "amount": [90, 180], "weight": 20}
                ]
            }
        ]
    },
        ...
        "enemies": [
            {
                ...
                "exp": 60,
                "drops": [
                    {"item": "地獄犬の牙", "weight": 35},
                    {"item": "業火の剣", "weight": 18},
                    {"item": "炎の鎧", "weight": 10},
                    {"item": "万能薬", "weight": 17},
                    {"item": "coins", "amount": [180, 320], "weight": 20}
                ]
            },
            {
                "name": "ヴァンパイアロード",
                ...
                "exp": 65,
                "drops": [
                    {"item": "吸血鬼の牙", "weight": 30},
                    {"item": "血の剣", "weight": 20},
                    {"item": "夜の外套", "weight": 15},
                    {"item": "万能薬", "weight": 15},
                    {"item": "coins", "amount": [200, 350], "weight": 20}
                ]
            },
            {
                "name": "リッチ",
                ...
                "exp": 68,
                "drops": [
                    {"item": "魔導書の欠片", "weight": 28},
                    {"item": "死霊の杖", "weight": 22},
                    {"item": "不死王の冠", "weight": 12},
                    {"item": "万能薬", "weight": 18},
                    {"item": "coins", "amount": [220, 380], "weight": 20}
                ]
            }
        ]
    },
        ...
        "enemies": [
            {
                ...
                "drops": [
                    ...
                    {"item": "暗黒の弓", "weight": 15},
                    {"item": "万能薬", "weight": 10},
                    {"item": "coins", "amount": [250, 420], "weight": 20}
                ]
            },
            {
                "name": "ベヒーモス",
                ...
                "drops": [
                    ...
                    {"item": "巨人の鎧", "weight": 15},
                    {"item": "万能薬", "weight": 15},
                    {"item": "coins", "amount": [280, 450], "weight": 20}
                ]
            },
            {
                "name": "シャドウロード",
                ...
                "drops": [
                    ...
                    {"item": "幻影の鎧", "weight": 13},
                    {"item": "万能薬", "weight": 17},
                    {"item": "coins", "amount": [300, 480], "weight": 20}
                ]
            }
        ]
    },
        ...
        "enemies": [
            {
                ...
                "exp": 90,
                "drops": [
                    {"item": "混沌の欠片", "weight": 30},
                    {"item": "カオスブレード", "weight": 22},
                    {"item": "混沌の鎧", "weight": 15},
                    {"item": "万能薬", "weight": 13},
                    {"item": "coins", "amount": [350, 520], "weight": 20}
                ]
            },
            {
                "name": "フェニックス",
                ...
                "weight": 30,
                "drops": [
                    {"item": "不死鳥の羽", "weight": 28},
                    {"item": "炎の剣", "weight": 20},
                    {"item": "再生の鎧", "weight": 12},
                    {"item": "万能薬", "weight": 20},
                    {"item": "coins", "amount": [380, 550], "weight": 20}
                ]
            },
            {
                "name": "デストロイヤー",
                ...
                "drops": [
                    ...
                    {"item": "終焉の盾", "weight": 15},
                    {"item": "万能薬", "weight": 20},
                    {"item": "coins", "amount": [400, 580], "weight": 20}
                ]
            }
        ]
    },
        ...
        "enemies": [
            {
                ...
                "weight": 35,
                "drops": [
                    {"item": "深淵の結晶", "weight": 28},
                    {"item": "深淵の剣", "weight": 22},
                    {"item": "虚空の鎧", "weight": 14},
                    {"item": "万能薬", "weight": 16},
                    {"item": "coins", "amount": [450, 620], "weight": 20}
                ]
            },
            {
                "name": "エレメンタルロード",
                ...
                "drops": [
                    ...
                    {"item": "精霊の盾", "weight": 14},
                    {"item": "万能薬", "weight": 20},
                    {"item": "coins", "amount": [480, 650], "weight": 20}
                ]
            },
            {
                "name": "タイタン",
                ...
                "drops": [
                    ...
                    {"item": "神の盾", "weight": 15},
                    {"item": "万能薬", "weight": 18},
                    {"item": "coins", "amount": [500, 680], "weight": 20}
                ]
            }
        ]
    },
        ...
        "enemies": [
            {
                ...
                "drops": [
                    ...
                    {"item": "堕天の鎧", "weight": 15},
                    {"item": "万能薬", "weight": 20},
                    {"item": "coins", "amount": [550, 720], "weight": 20}
                ]
            },
            {
                "name": "リヴァイアサン",
                ...
                "drops": [
                    ...
                    {"item": "深海の鎧", "weight": 14},
                    {"item": "万能薬", "weight": 20},
                    {"item": "coins", "amount": [580, 750], "weight": 20}
                ]
            },
            {
                "name": "ケルベロス",
                ...
                "drops": [
                    {"item": "三首の牙", "weight": 26},
                    {"item": "獄炎の剣", "weight": 20},
                    {"item": "地獄門の鎧", "weight": 14},
                    {"item": "万能薬", "weight": 20},
                    {"item": "coins", "amount": [600, 780], "weight": 20}
                ]
            }
        ]
    },
        ...
        "enemies": [
            {
                ...
                "drops": [
                    ...
                    {"item": "幻王の鎧", "weight": 15},
                    {"item": "万能薬", "weight": 23},
                    {"item": "coins", "amount": [650, 820], "weight": 20}
                ]
            },
            {
                "name": "ドラゴンロード",
                ...
                "drops": [
                    ...
                    {"item": "竜帝の鎧", "weight": 12},
                    {"item": "万能薬", "weight": 25},
                    {"item": "coins", "amount": [700, 850], "weight": 25}
                ]
            },
            {
                "name": "カオスゴッド",
                ...
                "weight": 20,
                "drops": [
                    {"item": "神殺しの結晶", "weight": 18},
                    {"item": "混沌神剣", "weight": 16},
                    {"item": "創世の盾", "weight": 12},
                    {"item": "万能薬", "weight": 29},
                    {"item": "coins", "amount": [750, 900], "weight": 25}
                ]
            },
            {
                "name": "デスエンペラー",
                ...
                "drops": [
                    ...
                    {"item": "死帝の鎧", "weight": 14},
                    {"item": "万能薬", "weight": 28},
                    {"item": "coins", "amount": [780, 950], "weight": 20}
                ]
            }
        ]
    }
...
BOSS_DATA = {
    1: {
        ...
        "drops": [
            {"item": "王者の剣", "weight": 40},
            {"item": "スライムの王冠", "weight": 30},
            {"item": "高級回復薬", "weight": 20},
            {"item": "coins", "amount": [200, 500], "weight": 10}
        ]
    },
    2: {
        "name": "デスロード",
        ...
        "drops": [
            ...
            {"item": "不死の鎧", "weight": 30},
            {"item": "万能薬", "weight": 25},
            {"item": "coins", "amount": [400, 800], "weight": 10}
        ]
    },
    3: {
        "name": "炎獄の魔竜", "hp": 400,
        ...
        "drops": [
            ...
            {"item": "万能薬", "weight": 15},
            {"item": "coins", "amount": [600, 1200], "weight": 5}
        ]
    },
    4: {
        "name": "影の王",
    ...
    5: {
        ...
        "drops": [
            ...
            {"item": "祝福の盾", "weight": 30},
            {"item": "万能薬", "weight": 25},
            {"item": "coins", "amount": [1000, 2000], "weight": 10}
        ]
    },
    6: {
        "name": "氷の女王",
        ...
        "drops": [
            ...
            {"item": "氷の鎧", "weight": 30},
            {"item": "万能薬", "weight": 25},
            {"item": "coins", "amount": [1200, 2500], "weight": 10}
        ]
    },
    7: {
        "name": "獄炎の巨人",
        ...
        "drops": [
            ...
            {"item": "炎の大剣", "weight": 30},
            {"item": "万能薬", "weight": 25},
            {"item": "coins", "amount": [1500, 3000], "weight": 10}
        ]
    },
    8: {
        "name": "深淵の守護者",
        ...
        "drops": [
            ...
            {"item": "勇者の鎧", "weight": 25},
            {"item": "万能薬", "weight": 30},
            {"item": "coins", "amount": [2000, 4000], "weight": 10}
        ]
    },
    9: {
        "name": "混沌の龍帝",
        ...
        "drops": [
            ...
            {"item": "竜の鱗", "weight": 30},
            {"item": "万能薬", "weight": 25},
            {"item": "coins", "amount": [3000, 5000], "weight": 10}
        ]
    },
    10: {
        "name": "終焉の魔王",
        ...
        "drops": [
            {"item": "魔王の剣", "weight": 30},
            {"item": "終焉の鎧", "weight": 30},
            {"item": "魔王の指輪", "weight": 20},
            {"item": "万能薬", "weight": 15},
            {"item": "coins", "amount": [5000, 10000], "weight": 5}
        ]
    }
}
...
def apply_ability_effects(damage, ability_text, attacker_hp, target_type="normal"):
    ...
    if "ランダム効果" in ability_text or "毎攻撃ランダム追加効果" in ability_text:
        ...
        elif random_effect == "paralyze":
            result["paralyze"] = True
            result["effect_text"] += "⚡ランダム:麻痺! "
        elif random_effect == "instant_kill":
    ...
    if "全能力" in ability_text:
        ...
        if all_match:
            all_bonus = int(all_match.group(1))
...
ITEMS_DATABASE["MP回復薬（小）"] = {
    "type": "potion",
    "effect": "MP+30",
    "ability": "MP回復",
    "description": "MPを30回復する薬。"
}
ITEMS_DATABASE["MP回復薬（中）"] = {
    "type": "potion",
    "effect": "MP+60",
    "ability": "MP回復",
    "description": "MPを60回復する薬。"
}
ITEMS_DATABASE["MP回復薬（大）"] = {
    "type": "potion",
    "effect": "MP+100",
    "ability": "MP大回復",
