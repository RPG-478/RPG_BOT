...
STORY_DATA = {
    ...
    "intro_2": {
        ...
        "lines": [
            ...
            {
                "speaker": "ナレーション",
                "text": "先ほどと全く同じ景色が広がっている。"
            },
            {
                "speaker": "冒険者",
                "text": "夢だったのか…？しかし地獄のような光景は全く同じだ。"
            },
            {
                "speaker": "???",
    ...
    "story_250": {
        ...
        "lines": [
            {
                "speaker": "ナレーション",
                "text": "スライム状の高原のような景色が広がっている。"
            },
            {
                "speaker": "ナレーション",
                "text": "どこもかしこも弾力があり、奥には次の階層へ続く大穴が見える。"
            },
            {
                "speaker": "ナレーション",
                "text": "この不思議な景色にあっけにとられながらも、冒険者は歩みを進める。"
            }
        ]
    },
    "story_750": {
        ...
        "lines": [
            {
                "speaker": "冒険者",
                "text": "地面に落ちている手記を発見した。"
            },
            {
                "speaker": "ボロボロの手記",
                "text": "このダンジョンは、果てしなく長く続くように見える。」"
            },
            {
                "speaker": "ボロボロの手記",
                "text": "ここはまだまだ始まりに過ぎない。」"
            },
            {
                "speaker": "ナレーション",
                "text": "誰がいつ、これを書いたのだろうか…"
            }
        ]
    },
    "story_1250": {
        ...
        "lines": [
            {
                "speaker": "ナレーション",
                "text": "奥からゾンビが、よろよろと弱弱しく近づいてくる。"
            },
            {
                "speaker": "素材商人",
                "text": "おっと、その獲物は俺のモノだぜ。"
            },
            {
                "speaker": "ナレーション",
                "text": "さらに奥から出てきた素材商人が、ゾンビの背後からトドメを刺し、ゾンビの肉を剥ぎ始めた。"
            },
            {
                "speaker": "素材商人",
                "text": "俺はこういうモンスターの素材の買い取りを行ってんだ。"
            },
            {
                "speaker": "素材商人",
                "text": "余ってる素材があったらぜひとも売ってくれよな！"
            },
            {
                "speaker": "ナレーション",
                "text": "怖い人だと思ったが、同時に頼りになる存在だとあなたは思った。"
            }
        ]
    },
    "story_1750": {
        ...
        "lines": [
            {
                "speaker": "ナレーション",
                "text": "遠くからぴちゃぴちゃと水滴の音が聞こえる。"
            },
            {
                "speaker": "ナレーション",
                "text": "天井から降ってきているのは、光る滴。"
            },
            {
                "speaker": "ナレーション",
                "text": "光る滴は地面に落ちるたびに周囲の形を変えて這いずり、溶けていく。"
            },
            {
                "speaker": "ナレーション",
                "text": "それはまるで、ダンジョンが自らを修復しているように見えた。"
            }
        ]
    },
    "story_2250": {
    ...
    "boss_post_1": {
        ...
        "lines": [
            {
                "speaker": "ナレーション",
                "text": "第一階層の主、スライムキングを倒した…！"
            },
            {
                "speaker": "ナレーション",
                "text": "これで第二階層へ進むことができる。"
            },
            {
                "speaker": "ナレーション",
                "text": "第二階層は、腐敗の小道。あなたは雲のような霧の中を進んでいく。"
            },
        ]
    },
    "boss_pre_2": {
    ...
    "boss_post_2": {
        ...
        "lines": [
            {
                "speaker": "ナレーション",
                "text": "第二階層の主、デスロードを倒した…！"
            },
            {
                "speaker": "ナレーション",
                "text": "デスロードが霧のように消え去っていく。"
            },
            {
                "speaker": "ナレーション",
                "text": "あなたは第三階層、灼熱の湖を進み始める。"
            }
        ]
    },
    "boss_pre_3": {
